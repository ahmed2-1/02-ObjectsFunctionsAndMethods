...
def main():
    ...
    # even_better_draw_circles(rg.Point(225, 50), 10, 5, 'red', 3)
    # even_better_draw_circles(rg.Point(-200, 0), 15, 25, "cyan", 10)
    even_better_draw_circles(rg.Point(0, 475), 500, 1, 'light gray', 250)
    even_better_draw_circles(rg.Point(-135, 75), 200, 1, 'black', 125)
    even_better_draw_circles(rg.Point(135, 75), 200, 1, 'black', 125)
    even_better_draw_circles(rg.Point(0, 150), 150, 1, 'gold', 75)
    # minimalist moon rover
    window.update()
...
def even_better_draw_circles(point, radius, circle_num, color, thickness):
    ...
    for k in range(circle_num):  # k becomes 1, 2, 3, ... 10
